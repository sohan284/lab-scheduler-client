    ...
    <div className='container mx-auto'>
            ...
            <div className='flex gap-3 items-center justify-center mx-4 md:mx-0'>
                <div className="relative mt-1 w-full md:w-2/5">
                    <input type="text" id="password" className="w-full pl-3 pr-10 py-2 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 hover:border-blue-500 transition-colors" />
                ...
                <div>
                    <button className='px-5 py-[6px] bg-[#522c80] text-white rounded-lg'>Search</button>
                </div>
            </div>
            {/* Custom scroll area */}
                    ...
                    <div key={tutorial.id} className='mt-12 md:mt-20'>
                        <div className='grid justify-center'>
                            <div className='flex justify-between'>
                                <div className='text-xs font-bold text-gray-600'>{tutorial.name}</div>
